						...
						<div class="form-border tourist-data-border">
							...
							<form role="form" {on submit {fn: 'onScanOver', scope: this}/} {id 'frmTourist'/}>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="guideName" {id "GUIDE_NAME"/} placeholder="Guide Name" value="${this.data.touristScanSession.guideName}">
								</div>
								<div class="form-group">
									<label for="AREA_CODE_1">Area Code</label>
									<input type="text" class="form-control" name="areaCode" {id "AREA_CODE"/} placeholder="Area Code" value="${this.data.touristScanSession.areaCode}">
								</div>
								<div class="form-group">
